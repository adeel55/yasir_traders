          ...
          <div class="md-layout">
            <div class="md-layout-item md-medium-size-100 md-xsmall-size-100 md-size-33">
              <md-field>
                ...
                <md-input v-model="filtercustomer" @input="getResults" type="text"></md-input>
              </md-field>
            </div>
            <div class="md-layout-item md-medium-size-100 md-xsmall-size-100 md-size-33">
              <md-field>
                <label>by saleman</label>
                <md-input v-model="filtersaleman" @input="getResults" type="text"></md-input>
              </md-field>
            </div>
            <div class="md-layout-item md-medium-size-100 md-xsmall-size-100 md-size-33">
              <md-field>
                <label>by orderbooker</label>
                <md-input v-model="filterorderbooker" @input="getResults" type="text"></md-input>
              </md-field>
            </div>
          </div>
          <md-card-header data-background-color="green">
            <h4 class="title">Released Invoices</h4>
            <a href="/"></a>
          </md-card-header>
          <md-card-content>
            <div>
