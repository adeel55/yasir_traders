@extends('layouts.main')
	...
	<div class="row filters p-2">
		...
		<div class="col-lg-4 col-md-6 col-sm-12 p-1">
  			<div class="input-group input-group-sm">
	  			...
	  			<input type="text" id="filterstrjoinsalemen-name" oninput="filter()" class="filter form-control">
  			</div>
		</div>
		<div class="col-lg-4 col-md-6 col-sm-12 p-1">
  			<div class="input-group input-group-sm">
	...
	<div class="row">
		<div class="col p-2">
			<table id="table" data-url="/invoice_receive" class="table table-sm table-hover">
			</table>
		</div>
	</div>
