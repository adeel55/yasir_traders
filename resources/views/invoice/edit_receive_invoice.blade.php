			...
			<form action="#">
				<div class="card invoice">
				  ...
				  <div class="card-body p-2">
				  	<div class="row m-0">
				  		...
				  		<div class="col-6 p-1">
				  			<div class="input-group input-group-sm">
					  			...
					  			<input type="date" name="date" class="form-control" class="form-control form-control-sm" value="{{ $invoice->invoicedate }}" id="date" required="required">
					  			@csrf
				  			</div>
				  		</div>
				  		<div class="col-lg-4 p-1">
				  			<div class="input-group input-group-sm">
					  			...
					  			<input type="text" name="customer" class="form-control" id="customer" value="{{ $invoice->customer }}" required="required">
				  			</div>
				  		</div>
				  		<div class="col-lg-4 p-1">
				  			<div class="input-group input-group-sm">
					  			...
					  			<input type="text" name="orderbooker" class="form-control" value="{{ $invoice->orderbooker }}" id="orderbooker" required="required">
				  			</div>
				  		</div>
				  		<div class="col-lg-4 p-1">
				  			<div class="input-group input-group-sm">
					  			...
					  			<input type="text" name="saleman" class="form-control" value="{{ $invoice->saleman }}" id="saleman" required="required">
				  			</div>
				  		</div>
				  	</div>
				  	<hr>
					<table class="table table-sm small invoice-table">
						...
						<tbody id="tbody">
							...
							<tr>
								<td>
									<input type="text" name="product" class="form-control form-control-sm product" value="{{ $sale->product_name }}" placeholder="product" required="required">
				  ...
				  <div class="card-footer d-print-none">
				    ...
				    <button class="btn btn-success" id="addstock" type="submit">Update</button>
