@extends('layouts.main')
	...
	<div class="row filters p-2">
		...
		<div class="col-lg-4 col-md-6 col-sm-12 p-1 d-print-none">
  			<a href="/orderbooker/create" class="btn btn-sm btn-success"><i class="fa fa-plus"></i> Add New</a>
		</div>
	</div>
	<div class="row">
		<div class="col">
			<table id="table" data-url="/orderbooker" class="table table-sm small table-responsive w-100 d-block d-md-table table-hover">
			</table>
		</div>
	</div>
